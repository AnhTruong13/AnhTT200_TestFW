...
- banner:
  ...
  - list:
    ...
    - listitem:
      - link " Contact us":
        - /url: /contact_us
    - listitem:  Logged in as TestUser_1755347403279_2479
- list:
  - listitem
  - listitem
  - listitem
...
- paragraph:
  ...
  - link "AI-powered automation software":
    - img
    - text: AI-powered automation software
  - link "API testing platform":
    - img
    - text: API testing platform
  - link "Continuous testing platform":
    - img
    - text: Continuous testing platform
- link "Test Cases":
  - /url: /test_cases
  - button "Test Cases"
...
- insertion
- img
- link "Go to shopping options for Embroidered Cotton Dress": Embroidered Cotton Dress
