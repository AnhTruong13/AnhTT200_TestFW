...
- banner:
  ...
  - list:
    ...
    - listitem:
      - link " Contact us":
        - /url: /contact_us
    - listitem:  Logged in as TestUser_To_delete
- list:
  - listitem
  - listitem
  - listitem
...
- paragraph:
  ...
  - link "API testing tool":
    - img
    - text: API testing tool
  - link "Online QA training":
    - img
    - text: Online QA training
- link "Test Cases":
  - /url: /test_cases
  - button "Test Cases"
...
- img
- link "Go to shopping options for Pure Cotton T-shirt": Pure Cotton T-shirt
